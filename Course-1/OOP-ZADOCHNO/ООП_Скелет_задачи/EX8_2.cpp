...
public:
	...
	Parent( char * );			// Инициализиращ конструктор
...
public:
	...
	Child( char *, char * );	// Инициализиращ конструктор
...
public:
	...
	GrandChild( char *, char *, char * );		// Инициализиращ конструктор
...
char *GrandChild::getClassName(void)
{
	return "GrandChild";
}
